...
newnode=(struct stacknode*)malloc(sizeof(struct stacknode)); printf("\n enter a value :\n");
scanf("%d",&newnode->data); if(top==NULL)
{
newnode->next=NULL; top=newnode;
}
else
{
...
{
struct stacknode *temp=top; top=temp->next;
...
void display()
{
struct stacknode *temp=top; if(top==NULL)
printf("\n STACK IS EMPTY!\n"); else
{
while(temp!=NULL)
{
